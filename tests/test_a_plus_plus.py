...
class TestToolsMock:
    ...
    def test_get_structured_observation_daily(self):
        ...
        print("✅ get_structured_observation (D) 测试通过")
...
if __name__ == "__main__":
    ...
    TestToolsMock().test_get_latest_observation()
    if HAS_LANGGRAPH:
